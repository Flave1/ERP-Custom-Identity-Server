...
{
    public class GetWorkflowLevelStaffsByStaffQueryHandler : IRequestHandler<GetWorkflowLevelStaffsByStaffQuery, WorkflowlevelStafRespObj>
    {
        private readonly IWorkflowRepository _repo;
        private readonly IAdminRepository _adminRepo;
        public GetWorkflowLevelStaffsByStaffQueryHandler(IAdminRepository adminRepository, IWorkflowRepository repository)
        {
            _repo = repository;
            _adminRepo = adminRepository;
        }
        public async Task<WorkflowlevelStafRespObj> Handle(GetWorkflowLevelStaffsByStaffQuery request, CancellationToken cancellationToken)
        {
            ...
            var item = await _repo.GetWorkflowLevelStaffsByStaffAsync(request.StaffId);
